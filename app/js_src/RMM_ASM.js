...
//
    ...
    function carryforwardSet() {
        ...
        carries[0] = parseInt((calcColumn(1, opASM) + carries[1]) / 10, 10);
        // handle A2 equation with a hundreds carry & no numbers in rows 0 & 1
        if (prob_asm[0][0] === null && prob_asm[1][0] === null && prob_asm[2][0] === 1) {
            carries[0] = 1;
        }
    }
