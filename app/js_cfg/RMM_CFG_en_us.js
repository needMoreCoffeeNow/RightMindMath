 RMM_CFG = (function() {
    ...
    var innerHtml = {
        ...
        div_stats_export_close_txt : '<span style="font-size:90%;"><p><u>CSV Export Info</u></p><p><b>idsession:</b> is the time stamp a session started followed by the count of the number of problems solved in that session.</p><p><b>timestamp:</b> is the time stamp part of idesssion.</p><p><b>problemNum:</b> is the count of the problems done part of idesssion.</p><p><b>Date:</b> is the time stamp formatted for reading by spread sheet apps. (Note: you can select either MM/DD/YYYY or DD/MM/YYYY formats.)</p><p><b>time:</b> is the total amount of time to correctly answer a problem.</p><p><p><b>tries:</b> for single-digit problems this is the number of tries needed (1-4) to select the right answer.</p><p><p><b>ordered:</b> when the problem type is single-digit multiplication, this field will be True when the equations were ordered (e.g. 2x1, 2x2, 2x3, etc.). If blank the equations were presented randomly.</p><p><hr><p>Sort the data on <u>idsession</u> before doing any charting.<hr></span>',
        m1_digit_txt : 'Number&nbsp;&nbsp;&nbsp;',
