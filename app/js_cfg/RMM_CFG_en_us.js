 RMM_CFG = (function() {
    ...
    var innerHtml = {
        ...
        div_menu_addneg_text : 'Select how many problems with a <u>negative lowern operand</u> you want for every 10 one-digit addition problems shown.<br><span style="font-size:80%;">Examples: 5 + -7 = -2  and  3 + -2 = 1</span>.<br><br>The <span style="color:#0000ff;">Current Setting</span> is:',
        //////div_menu_addtopneg_text : 'Select how many times out of ten you want the problem to have a negative <u>top number</u> <span style="font-size:80%;">(e.g. -5 + 3 = -2)</span>. The <span style="color:#0000ff;">Current Setting</span> is:',
        //////div_menu_subtopneg_text : 'Select how many times out of ten you want the problem to have a negative <u>top number</u> <span style="font-size:80%;">(e.g. -4 - 3 = -7)</span>. The <span style="color:#0000ff;">Current Setting</span> is:',
